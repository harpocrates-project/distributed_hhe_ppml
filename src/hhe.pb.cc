...
const uint32_t TableStruct_hhe_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::hheproto::MLModelMsg, _impl_.bias_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 31, -1, -1, sizeof(::hheproto::MLModelMsg)},
...
const char descriptor_table_protodef_hhe_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ngth\030\002 \001(\005\"]\n\nMLModelMsg\022(\n\007weights\030\001 \001("
  "\0132\027.hheproto.CiphertextMsg\022%\n\004bias\030\002 \001(\013"
  "2\027.hheproto.CiphertextMsg\";\n\023EncSymmetri"
  "cKeysMsg\022$\n\003key\030\001 \003(\0132\027.hheproto.Ciphert"
  "extMsg\"$\n\023EncSymmetricDataMsg\022\r\n\005value\030\001"
  " \003(\0042\215\001\n\016AnalystService\0229\n\014getPublicKey\022"
  "\017.hheproto.Empty\032\026.hheproto.PublicKeyMsg"
  "\"\000\022@\n\022addEncryptedResult\022\027.hheproto.Ciph"
  "ertextMsg\032\017.hheproto.Empty\"\0002\216\002\n\nCSPServ"
  "ice\022=\n\raddPublicKeys\022\031.hheproto.PublicKe"
  "ySetMsg\032\017.hheproto.Empty\"\000\0225\n\naddMLModel"
  "\022\024.hheproto.MLModelMsg\032\017.hheproto.Empty\""
  ...
  "sg\032\017.hheproto.Empty\"\000B\006\242\002\003HHEb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_hhe_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_hhe_2eproto = {
    false, false, 877, descriptor_table_protodef_hhe_2eproto,
    "hhe.proto",
...
class MLModelMsg::_Internal {
 public:
  static const ::hheproto::CiphertextMsg& weights(const MLModelMsg* msg);
  static const ::hheproto::CiphertextMsg& bias(const MLModelMsg* msg);
};

const ::hheproto::CiphertextMsg&
MLModelMsg::_Internal::weights(const MLModelMsg* msg) {
  return *msg->_impl_.weights_;
}
const ::hheproto::CiphertextMsg&
MLModelMsg::_Internal::bias(const MLModelMsg* msg) {
...
MLModelMsg::MLModelMsg(const MLModelMsg& from)
  ...
  if (from._internal_has_weights()) {
    _this->_impl_.weights_ = new ::hheproto::CiphertextMsg(*from._impl_.weights_);
  }
  if (from._internal_has_bias()) {
    _this->_impl_.bias_ = new ::hheproto::CiphertextMsg(*from._impl_.bias_);
  }
...
void MLModelMsg::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_weights()) {
    _this->_internal_mutable_weights()->::hheproto::CiphertextMsg::MergeFrom(
        from._internal_weights());
  }
  if (from._internal_has_bias()) {
    _this->_internal_mutable_bias()->::hheproto::CiphertextMsg::MergeFrom(
        from._internal_bias());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void MLModelMsg::InternalSwap(MLModelMsg* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MLModelMsg, _impl_.bias_)
      + sizeof(MLModelMsg::_impl_.bias_)
      - PROTOBUF_FIELD_OFFSET(MLModelMsg, _impl_.weights_)>(
