...
static const char* MyService_method_names[] = {
  "/hheproto.MyService/GetResponse",
};
...
MyService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_GetResponse_(MyService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}

::grpc::Status MyService::Stub::GetResponse(::grpc::ClientContext* context, const ::hheproto::MyRequest& request, ::hheproto::MyResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::hheproto::MyRequest, ::hheproto::MyResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetResponse_, context, request, response);
}

void MyService::Stub::async::GetResponse(::grpc::ClientContext* context, const ::hheproto::MyRequest* request, ::hheproto::MyResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::hheproto::MyRequest, ::hheproto::MyResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetResponse_, context, request, response, std::move(f));
}

void MyService::Stub::async::GetResponse(::grpc::ClientContext* context, const ::hheproto::MyRequest* request, ::hheproto::MyResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetResponse_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::hheproto::MyResponse>* MyService::Stub::PrepareAsyncGetResponseRaw(::grpc::ClientContext* context, const ::hheproto::MyRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::hheproto::MyResponse, ::hheproto::MyRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetResponse_, context, request);
}

::grpc::ClientAsyncResponseReader< ::hheproto::MyResponse>* MyService::Stub::AsyncGetResponseRaw(::grpc::ClientContext* context, const ::hheproto::MyRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetResponseRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
MyService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< MyService::Service, ::hheproto::MyRequest, ::hheproto::MyResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](MyService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::hheproto::MyRequest* req,
             ::hheproto::MyResponse* resp) {
               return service->GetResponse(ctx, req, resp);
             }, this)));
}
...
::grpc::Status MyService::Service::GetResponse(::grpc::ServerContext* context, const ::hheproto::MyRequest* request, ::hheproto::MyResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
